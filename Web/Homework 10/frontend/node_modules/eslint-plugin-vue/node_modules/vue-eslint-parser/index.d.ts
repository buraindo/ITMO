...
declare module 'vue-eslint-parser/ast/nodes' {
    ...
    export type Node = ESLintNode | VNode | VForExpression | VOnExpression | VSlotScopeExpression;
    ...
    export interface VExpressionContainer extends HasLocation, HasParent {
        ...
        expression: ESLintExpression | VForExpression | VOnExpression | VSlotScopeExpression | null;
        references: Reference[];
    }
