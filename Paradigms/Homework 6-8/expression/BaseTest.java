...
import exceptionsLib.IllegalOperationException;
import exceptionsLib.OverflowException;
...
public abstract class BaseTest {
    ...
    public void run() throws OverflowException, IllegalOperationException {
        test();
        counter.printStatus(getClass());
    }

    protected abstract void test() throws OverflowException, IllegalOperationException;
